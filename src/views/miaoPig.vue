        ...
        <div class="c-d-f c-ai-c c-p-20 c-fs-22 pig-info-top">
          ...
          <div class="c-ml-40 c-c-text-grey text-wrap">
            ...
            <div class="c-d-f c-jc-sb c-ai-c">
              <span>预计秒杀时间：{{pigInfo.killTime}}</span>
            </div>
                    ...
                    <div v-for="(item, index) in placeGoodsList" :key="index" class="c-ml-20 c-mb-20 c-mr-10 c-bc-white c-br-10">
                      ...
                      <div class="c-d-f c-ai-c c-p-20 c-pl-20 c-fs-24 c-c-text-grey pig-order-detail">
                        ...
                        <div class="c-ml-30 text-wrap c-w-100">
                          <div class="c-fs-20 c-tag-yellow" style="width: 50%;">预估重量：{{item.weight}}</div>
                          <div class="c-d-f c-jc-sb c-ai-fe">
                            <div class="c-d-f c-fd-c c-ai-c" style="width: 50%; text-align: center;">
                              <span class="c-mb-5 c-c-text-grey-dark c-fw-5">秒杀价格</span>
                              <span class="c-fs-26 c-fw-b c-c-text-red">¥ {{item.dealPrice}}</span>
                            </div>
                            <div class="c-p-r pai-btn" @click="clickItem(item)" :class="item.isMiao ? 'btn-disabled' : ''">
                              <span class="c-p-c">秒 杀</span>
                            </div>
                          </div>
                        </div>
                      </div>
